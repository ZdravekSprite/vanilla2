...
class EarnController extends Controller
{
  ...
  public function update(UpdateEarnRequest $request, EarnLP $earn)
  {
    ...
    switch ($request->earn) {
      case 'SELP':
        return (new BinanceHelpers)->getSimpleEarnLockedPosition(true);
      ...
      case 'SELL':
        return (new BinanceHelpers)->getSimpleEarnLockedList(true);
      ...
      case 'SEFP':
        return (new BinanceHelpers)->getSimpleEarnFlexiblePosition(true);
      ...
      case 'SEFL':
        return (new BinanceHelpers)->getSimpleEarnFlexibleList(true);
